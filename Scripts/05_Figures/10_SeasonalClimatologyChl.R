...
yearmed = rast(list.files("Data/Modis/Seasonal/Climatology/",pattern="Medianchl", full.names = T ))
...
#chl.palette = rev(brewer.spectral(length(chlbreaks)-1))
...
png("./Figures//SeasonalClimatologyChl.png", width=6.7 ,height=4.5,res=300,unit="in", pointsize = 10)
