...
yearmed = rast(list.files("Data/Modis/Seasonal/Climatology/",pattern="Medianspm", full.names = T ))
...
png("./Figures//SeasonalClimatologySPM.png", width=6.7 ,height=4.5,res=300,unit="in", pointsize = 10)
