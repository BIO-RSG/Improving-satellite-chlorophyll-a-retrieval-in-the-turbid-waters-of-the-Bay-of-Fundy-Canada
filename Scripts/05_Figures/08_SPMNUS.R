...
setwd("")
sat.dat = read.csv("./Data/SPMMatchup/ModisSPM.csv")



##Data Cleanup
sat.dat = sat.dat[sat.dat$METHOD=="NUS",]
sat.dat = sat.dat[sat.dat$validn>=5,]


in.col = rev(brewer.spectral(15))
png("./Figures//SPMMatchup.png",pointsize = 10, width=6.5, height= 3.5, units="in",res=300)
