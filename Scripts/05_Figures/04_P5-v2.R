...
setwd("")
#
oc3 = read.csv("./Data/Prince5/modisOC3matchups.csv")
oc3 = oc3[,-1]
oc3 = apply(oc3, 2, median, na.rm=T)
m2 = read.csv("./Data/Prince5/modism2matchups.csv")
m2= m2[,-1]
...
png("./Figures//Prince5.png", width=6.5 ,height=6.5,res=300,unit="in", pointsize = 10)
