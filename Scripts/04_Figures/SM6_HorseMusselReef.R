...
setwd("")
#
oc3 = read.csv("./Data/HorseMussel/OCXHorseMussel.csv")
oc3 = oc3[,-1]
oc3 = oc3[,-1]
a= apply(oc3, 2, sum, na.rm=T)
a=which(a>0)
oc3 = oc3[,a]
m2 = read.csv("./Data/HorseMussel/M2HorseMussel.csv")
m2= m2[,-1]
m2= m2[,-1]
m2=m2[,a]
insitu = read.csv("./Data/HorseMussel/HorseMussel.csv")
...
png("./Figures//HorseMussel.png", width=6.5 ,height=4.5,res=300,unit="in", pointsize = 10)
...
boxplot(list(insitu$DATA_VALUE[insitu$MONTH==1],
             ...
             insitu$DATA_VALUE[insitu$MONTH==11]),
        xlab="", ylab=expression("In situ chl-a (mg/m"^3*")"),pch=20, ylim=c(0.02,100),log="y",
...
boxplot(list(plot.dat.med$oc3[plot.dat.med$MONTH==1],
             ...
             plot.dat.med$oc3[plot.dat.med$MONTH==11]),
        xlab="", ylab=expression("Satellite chl-a (mg/m"^3*")"),pch=20, ylim=c(0.02,100),log="y",
        xaxt="n",xaxs="i",yaxs="i")
axis(1, at=c(1:12), labels=c("Jan","Feb","Mar","Apr","May","June","July",
                             "Aug","Sept","Oct","Nov","Dec"))
...
#plot(y= plot.dat.med$oc3 , x= plot.dat.med$modisdate, xlab="",ylab=expression("chl-a (mg/m"^3*")"),
 #    pch=20, ylim=c(0.02,100), log="y",col=alpha(cubicl(8)[3]),yaxs="i")
